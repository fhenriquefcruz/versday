...
export const semanticThemes = [
  ...
  {
    name: 'paz',
    keywords: ['paz', 'calma', 'descanso', 'tranquilidade', 'serenidade', 'sossego', 'quieto', 'remanso'],
    images: [
  ...
  {
    name: 'amor',
    keywords: ['amor', 'bondade', 'misericórdia', 'compaixão', 'ágape', 'querido', 'amado', 'caridade'],
    images: [
      'https://images.pexels.com/photos/56866/garden-rose-red-pink-56866.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/2387795/pexels-photo-2387795.jpeg?auto=compress&cs=tinysrgb&w=1600'
    ]
  },
  {
    name: 'fé',
    keywords: ['fé', 'crer', 'confiar', 'esperança', 'perseverança', 'crente', 'fidelidade', 'confiança'],
    images: [
  ...
  {
    name: 'força',
    keywords: ['força', 'coragem', 'fortaleza', 'poder', 'vencer', 'vitória', 'robusto', 'firme', 'ânimo'],
    images: [
      'https://images.pexels.com/photos/618848/pexels-photo-618848.jpeg?auto=compress&cs=tinysrgb&w=1600',
  ...
  {
    name: 'gratidão',
    keywords: ['gratidão', 'agradecer', 'bênção', 'dádiva', 'louvor', 'ações de graças', 'reconhecimento'],
    images: [
      'https://images.pexels.com/photos/1146762/pexels-photo-1146762.jpeg?auto=compress&cs=tinysrgb&w=1600',
  ...
  {
    name: 'sabedoria',
    keywords: ['sabedoria', 'entendimento', 'conhecimento', 'discernimento', 'instrução', 'prudência'],
    images: [
  ...
  {
    name: 'pastor',
    keywords: ['pastor', 'rebanho', 'ovelha', 'ovelhas', 'apascentar', 'guia'],
    images: [
      'https://images.pexels.com/photos/1687845/pexels-photo-1687845.jpeg?auto=compress&cs=tinysrgb&w=1600',
      'https://images.pexels.com/photos/1472133/pexels-photo-1472133.jpeg?auto=compress&cs=tinysrgb&w=1600'
    ]
  },
  {
    name: 'natureza',
    keywords: ['natureza', 'criação', 'campo', 'flor', 'flores', 'árvore', 'floresta', 'jardim', 'arvoredo'],
    images: [
  ...
  {
    name: 'água',
    keywords: ['água', 'águas', 'rio', 'rios', 'mar', 'mares', 'fonte', 'cachoeira', 'oceano', 'praia', 'ondas', 'corrente', 'correntes'],
    images: [
  ...
  {
    name: 'céu',
    keywords: ['céu', 'céus', 'nuvem', 'nuvens', 'estrelas', 'estrela', 'firmamento', 'cosmos', 'astros'],
    images: [
  ...
  {
    name: 'caminho',
    keywords: ['caminho', 'caminhos', 'estrada', 'vereda', 'trilha', 'senda', 'rota'],
    images: [
  ...
  {
    name: 'luz',
    keywords: ['luz', 'lâmpada', 'brilho', 'resplendor', 'amanhecer', 'alvorada', 'aurora', 'clarão'],
    images: [
...
export const contemplativeImages = [
  ...
  'https://images.pexels.com/photos/147411/italy-mountains-dawn-daybreak-147411.jpeg?auto=compress&cs=tinysrgb&w=1600',
  'https://images.pexels.com/photos/443446/pexels-photo-443446.jpeg?auto=compress&cs=tinysrgb&w=1600',
  'https://images.pexels.com/photos/260689/pexels-photo-260689.jpeg?auto=compress&cs=tinysrgb&w=1600',
  'https://images.pexels.com/photos/1128797/pexels-photo-1128797.jpeg?auto=compress&cs=tinysrgb&w=1600',
  'https://images.pexels.com/photos/459654/pexels-photo-459654.jpeg?auto=compress&cs=tinysrgb&w=1600',
  'https://images.pexels.com/photos/1292115/pexels-photo-1292115.jpeg?auto=compress&cs=tinysrgb&w=1600',
  'https://images.pexels.com/photos/844124/pexels-photo-844124.jpeg?auto=compress&cs=tinysrgb&w=1600',
  'https://images.pexels.com/photos/344886/pexels-photo-344886.jpeg?auto=compress&cs=tinysrgb&w=1600'
];
...
export function getImageForVerse(verseText) {
  ...
  const themeObj = semanticThemes.find(t => t.name === classification.theme);
  if (themeObj && themeObj.images.length) {
    const rand = Math.floor(Math.random() * themeObj.images.length);
    return themeObj.images[rand];
  }
  const rand = Math.floor(Math.random() * contemplativeImages.length);
  return contemplativeImages[rand];
}
